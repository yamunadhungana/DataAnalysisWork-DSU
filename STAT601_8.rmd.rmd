...
```{r}
cat("Although we can choose waistcirc or hipcirc from the above pruned regression tree
    because it explaines the maximun data but I also want to choose by linear regression")
